...
func initTestRouteAccount(t *testing.T, am *DefaultAccountManager) (*types.Account, error) {
	...
	peer3 := &nbpeer.Peer{
		...
		ID:       peer3ID,
		Key:      peer3Key,
		Name:     "test-host3@rsoftware.net",
		DNSLabel: "test-host3",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host3@rsoftware.net",
			GoOS:      "darwin",
			Kernel:    "Darwin",
			Core:      "13.4.1",
			Platform:  "arm64",
	...
	peer4 := &nbpeer.Peer{
		...
		ID:       peer4ID,
		Key:      peer4Key,
		Name:     "test-host4@rsoftware.net",
		DNSLabel: "test-host4",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host4@rsoftware.net",
			GoOS:      "linux",
			Kernel:    "Linux",
			Core:      "21.04",
			Platform:  "x86_64",
	...
	peer5 := &nbpeer.Peer{
		...
		ID:       peer5ID,
		Key:      peer5Key,
		Name:     "test-host5@rsoftware.net",
		DNSLabel: "test-host5",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host5@rsoftware.net",
			GoOS:      "linux",
			Kernel:    "Linux",
			Core:      "21.04",
			Platform:  "x86_64",
