...
func createDNSManager(t *testing.T) (*DefaultAccountManager, error) {
	...
	return BuildManager(context.Background(), store, NewPeersUpdateManager(nil), nil, "", "rvpn.test", eventStore, nil, false, MockIntegratedValidator{}, metrics, port_forwarding.NewControllerMock(), settingsMockManager, permissionsManager, false)
}
