...
const (
	geoLiteCityTarGZURL     = "https://pkgs.rsoftware.net/geolocation-dbs/GeoLite2-City/download?suffix=tar.gz"
	geoLiteCityZipURL       = "https://pkgs.rsoftware.net/geolocation-dbs/GeoLite2-City-CSV/download?suffix=zip"
	geoLiteCitySha256TarURL = "https://pkgs.rsoftware.net/geolocation-dbs/GeoLite2-City/download?suffix=tar.gz.sha256"
	geoLiteCitySha256ZipURL = "https://pkgs.rsoftware.net/geolocation-dbs/GeoLite2-City-CSV/download?suffix=zip.sha256"
