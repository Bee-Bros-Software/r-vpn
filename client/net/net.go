...
const (
	// ControlPlaneMark is the fwmark value used to mark packets that should not be routed through the R-VPN interface to
	// avoid routing loops.
	...
	// PreroutingFwmarkMasquerade is applied to packets that arrive from the R-VPN interface and should be masqueraded.
	PreroutingFwmarkMasquerade = 0x1BD21

	// PreroutingFwmarkMasqueradeReturn is applied to packets that will leave through the R-VPN interface and should be masqueraded.
