...
// ServerDomains represents the management server domains extracted from R-VPN configuration
...
// ExtractFromNetbirdConfig extracts domain information from R-VPN protobuf configuration
...
// extractSignalDomain extracts the signal domain from R-VPN configuration.
...
// extractRelayDomains extracts relay server domains from R-VPN configuration.
...
// extractFlowDomain extracts the traffic flow domain from R-VPN configuration.
...
// extractStunDomains extracts STUN server domains from R-VPN configuration.
...
// extractTurnDomains extracts TURN server domains from R-VPN configuration.
