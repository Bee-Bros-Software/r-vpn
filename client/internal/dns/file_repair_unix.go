...
// nbParamsAreMissing checks if the resolv.conf file contains all the parameters that R-VPN needs
// check the R-VPN related nameserver IP at the first place
// check the R-VPN related search domains in the search domains list
