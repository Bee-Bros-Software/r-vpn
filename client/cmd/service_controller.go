...
func (p *program) Start(svc service.Service) error {
	...
	log.Info("starting R-VPN service") //nolint
...
func (p *program) Stop(srv service.Service) error {
	...
	log.Info("stopped R-VPN service") //nolint
	return nil
}
...
var startCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("R-VPN service has been started")
		return nil
	},
}
...
var stopCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("R-VPN service has been stopped")
		return nil
	},
}
...
var restartCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("R-VPN service has been restarted")
		return nil
	},
}
...
var svcStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "shows R-VPN service status",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel)
		if err != nil {
		...
		cmd.Printf("R-VPN service status: %s\n", statusText)
		return nil
	},
}
