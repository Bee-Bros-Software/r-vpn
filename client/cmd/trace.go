...
var traceCmd = &cobra.Command{
	...
	Example: `
  rvpn debug trace in 192.168.1.10 10.10.0.2 -p tcp --sport 12345 --dport 443 --syn --ack
  rvpn debug trace out 10.10.0.1 8.8.8.8 -p udp  --dport 53
  rvpn debug trace in 10.10.0.2 10.10.0.1 -p icmp --icmp-type 8 --icmp-code 0
  rvpn debug trace in 100.64.1.1 self -p tcp --dport 80`,
