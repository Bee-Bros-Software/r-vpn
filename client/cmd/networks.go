...
var networksCMD = &cobra.Command{
	...
	Short:   "Manage connections to R-VPN Networks and Resources",
...
var routesSelectCmd = &cobra.Command{
	...
	Example: "  rvpn networks select all\n  rvpn networks select route1 route2\n  rvpn routes select -a route3",
...
var routesDeselectCmd = &cobra.Command{
	...
	Example: "  rvpn networks deselect all\n  rvpn networks deselect route1 route2",
	Args:    cobra.MinimumNArgs(1),
