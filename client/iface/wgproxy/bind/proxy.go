...
type ProxyBind struct {
	...
	// wgRelayedEndpoint is a fake address that generated by the Bind.SetEndpoint based on the remote R-VPN peer address
...
// endpoint is the R-VPN address of the remote peer. The SetEndpoint return with the address what will be used in the
// WireGuard configuration.
//
// Parameters:
//   - ctx: Context is used for proxyToLocal to avoid unnecessary error messages
//   - nbAddr: The R-VPN UDP address of the remote peer, it required to generate fake address
