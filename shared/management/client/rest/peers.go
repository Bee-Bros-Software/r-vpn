...
// List list all peers
// See more: https://docs.rsoftware.net/api/resources/peers#list-all-peers
...
// Get retrieve a peer
// See more: https://docs.rsoftware.net/api/resources/peers#retrieve-a-peer
...
// See more: https://docs.rsoftware.net/api/resources/peers#update-a-peer
...
// See more: https://docs.rsoftware.net/api/resources/peers#delete-a-peer
...
// See more: https://docs.rsoftware.net/api/resources/peers#list-accessible-peers
