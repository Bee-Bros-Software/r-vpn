...
// See more: https://docs.rsoftware.net/api/resources/routes#list-all-routes
...
// Get get route info
// See more: https://docs.rsoftware.net/api/resources/routes#retrieve-a-route
...
// See more: https://docs.rsoftware.net/api/resources/routes#create-a-route
...
// See more: https://docs.rsoftware.net/api/resources/routes#update-a-route
...
// Delete delete route
// See more: https://docs.rsoftware.net/api/resources/routes#delete-a-route
