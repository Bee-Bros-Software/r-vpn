...
// See more: https://docs.rsoftware.net/api/resources/dns#list-all-nameserver-groups
...
// See more: https://docs.rsoftware.net/api/resources/dns#retrieve-a-nameserver-group
...
// See more: https://docs.rsoftware.net/api/resources/dns#create-a-nameserver-group
...
// See more: https://docs.rsoftware.net/api/resources/dns#update-a-nameserver-group
...
// See more: https://docs.rsoftware.net/api/resources/dns#delete-a-nameserver-group
...
// See more: https://docs.rsoftware.net/api/resources/dns#retrieve-dns-settings
...
// See more: https://docs.rsoftware.net/api/resources/dns#update-dns-settings
