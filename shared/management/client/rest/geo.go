...
// See more: https://docs.rsoftware.net/api/resources/geo-locations#list-all-country-codes
...
// See more: https://docs.rsoftware.net/api/resources/geo-locations#list-all-city-names-by-country
